        ...
        try {
            ...
            const response = await $.ajax({
                ...
                data: {
                    ...
                    FiltroPlanta: this.datos_usuario[0].PLANTA,
                    "FiltroArea": (this.datos_usuario[0].PLANTA == 1 ? 1 : 14) || null,
    ...
    agregarParosAlGridEnMemoria(paros, datosFormateados) {
        ...
        gruposParos.forEach(grupo => {
            ...
            if (filaExistente) {
                ...
                // Datos adicionales del primer item del grupo (igual que antes)
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        editable: false// editable por si cambia la meta
                    },
                    {
