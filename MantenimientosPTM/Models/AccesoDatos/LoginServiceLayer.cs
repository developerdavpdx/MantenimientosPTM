...
using static MantenimientosPTM.GlobalCommands;
...
namespace MantenimientosPTM.Service
{
    public class LoginServiceLayer
    {
        ...
        public async Task<SapResponse> LoginAsyncHttpClient()
        {
            // Se crea una respuesta por defecto, marcando error hasta que se valide lo contrario
            var responseAbx = new SapResponse { IsError = true };
        ...
        /// </returns>
        public async Task<SapResponse> LogoutAsyncHttpClient()
        {
            // Se crea una respuesta por defecto, marcando error hasta que se valide lo contrario
            var responseAbx = new SapResponse
            {
                IsError = true
            };
